...
INSERT INTO user (id, created_by, object_id, version, email, enabled, password) VALUES (-100, -1, 'USER-OBJ-100', 1, 'user@mail.com', 1, 'password');
INSERT INTO user (id, created_by, object_id, version, email, enabled, password) VALUES (-101, -1, 'USER-OBJ-101', 1, 'admin@mail.com', 1, 'password');
